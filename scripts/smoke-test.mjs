...
assert.match(html, /modal-acompanhamento-notificacao/);
assert.match(html, /acompanhamentoTipo/);
assert.match(html, /Terreno limpo — confirmado/);
...
assert.match(functionsSource, /recordNotificationFollowUp/);
assert.match(functionsSource, /Notificações emitidas são imutáveis/);
assert.match(functionsSource, /acompanhamentos/);
assert.match(workflow, /WORKFLOW_STAGES/);
assert.match(territory, /TEAM_1/);
assert.match(evidence, /uploadEvidence/);
assert.match(html, /id="textoPrazoRegularizacao"/);
assert.match(app, /prazoRegularizacaoDias: 15/);
...
assert.match(functionsSource, /maiorNumeroPersistido/);
assert.match(functionsSource, /Math\.max\(ultimoNumero, maiorExistente\)/);
assert.match(functionsSource, /suggestDocumentNumber/);
assert.match(functionsSource, /numNotifManual/);
assert.match(functionsSource, /normalizarNumeroManual/);
assert.match(app, /proximoNumeroLocal/);
assert.match(app, /definirNumeroSugerido/);
assert.match(app, /suggestDocumentNumber/);
assert.match(app, /numNotifManual/);
assert.match(app, /dinamico_residuos/);
assert.match(app, /tipoDoc !== 'notificacao' && etapaSelecionada !== etapaAnterior/);
