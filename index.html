                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
                        ...
                        <div class="panel-container" style="background: #1e293b; color: white;">
                            ...
                            <div style="font-size:11px; line-height:1.5; color:#cbd5e1; max-height:150px; overflow-y:auto; padding-right:5px; margin-bottom: 10px;">
                                ...
                                <strong>Automação Correios:</strong> O primeiro acesso após as 08h e 13h dispara um robô invisível em *background* para varrer os status via Proxy Público para contornar CORS e rate-limits. Feedback no Tooltip (mouse-over).<br>
